function [gFactorMC,gFactorK,gFactorX]=ScriptFigure_VD_Size128(SNR,rho,L,NEX,PLOT,filepath)
...
if (PLOT)
    ...
    print('/home/inaki/Escritorio/ProyectoMadison/CircularConv/Figure_VD/NoiseMap_VD_Size128','-dpng')
    ...
    print('/home/inaki/Escritorio/ProyectoMadison/CircularConv/Figure_VD/g-factor_VD_Size128','-dpng')
    ...
    print('/home/inaki/Escritorio/ProyectoMadison/CircularConv/Figure_VD/NoiseMapCross_VD_Size128','-dpng')
end

%We save the results
save([filepath '/Synthetic/Figure_VD/ResultsVD_SNR' num2str(SNR) '_Size128.mat'],'GammaK','CK','kernel','SNR','L','N','Walsh','Lines','mssLines','LnsKnl','mssKnl','Size','method','Reff','LinesACS','NoiseMapMCAcc','NoiseMapK','NoiseMapX','NoiseMapFull','NoiseMapMCFull','gFactorMC','gFactorK','gFactorX','NoiseMapCrossAcc','NoiseMapCrossK','NoiseMapCrossX')
end